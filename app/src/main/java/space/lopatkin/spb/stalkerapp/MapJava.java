...
public class MapJava extends AppCompatActivity {

    private static final int LayoutUI = R.layout.activity_map;
    ...
    private void openMainMenu() {
        try {
            Intent intent = new Intent(MapJava.this, MenuJava.class);
